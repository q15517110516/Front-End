...
class Register extends Component {
    ...
    onSubmit = e =>{
        ...
        //Add a parameter to 'this.props.history' within our call to 'this.props.registerUser(newUser, this.props.history)' in our 'onSubmit' event so we can access it within our action
